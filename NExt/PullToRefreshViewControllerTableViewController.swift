//
//  PullToRefreshViewControllerTableViewController.swift
//  NExt
//
//  Created by Douglas Sexton on 2/26/17.
...
class PullToRefreshTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.titleLabel.text = formatter.string(from: (nextItem.dueDate))
        cell.detailLabel.text = nextItem.text
